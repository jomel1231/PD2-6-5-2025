...
public class DashLineGroupManager : MonoBehaviour
{
    public List<DashLineTrigger> dashLines = new List<DashLineTrigger>();
    ...
    public void RegisterDashCleared(DashLineTrigger dash)
    {
        clearedCount++;
